...
VALUES (
    ...
    (
        8,
        'The Night Lands',
        '«The Night Lands» es el segundo episodio de la segunda temporada de la serie de fantasía medieval Game of Thrones de HBO. Tiene una duración de 51 minutos y se estrenó en 2 de abril de 2012 vía Internet por el servicio en línea de HBO GO en algunos países de Europa. Por televisión por suscripción se estrenó en Estados Unidos el 8 de abril de 2012. Fue escrito por sus creadores David Benioff y D. B. Weiss y dirigido por Alan Taylor. El episodio sigue con algunas de las historias del capítulo anterior: la caravana que se dirigía al Muro es detenida por la Guardia de la Ciudad, el Consejo recibe la carta con los términos de la paz de parte de Robb Stark, Daenerys espera por el regreso de los jinetes que ha enviado a explorar y Theon Greyjoy regresa a su hogar, las Islas del Hierro. \"Las tierras de la noche\" es el término usado en el lenguaje dothraki para muerte.',
        101,
        NULL,
        1,
        2
...
--
INSERT INTO `faq` (`id`, `question`, `answer`, `language`)
VALUES (
        1,
        '¿Qué es Maciflix?',
...
--
INSERT INTO `sala` (`id`, `name`, `rows`, `columns`)
